...
**Status:** Complete (Phase 4) — `phanes-ui` (eframe 0.34): explorer (folder tree + filter + ⟳ Scan to re-index in place), centre editor, and a right info panel (status/provenance/tags/topics + clickable related)
