...
**Themes.** The 🎨 dropdown in the top bar switches the whole UI between eight
themes — **Dark**, **Light**, **Parchment** (warm, serif), **Cyberpunk** (neon,
monospace), **Orphic** (cosmic indigo + gold), **Nord**, **Solarized**, and
**Gruvbox**. Your choice is remembered between runs.
